# Generated by Django 2.1.15 on 2020-10-13 08:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='PLN', max_digits=10, null=True)),
                ('record_date', models.DateTimeField(default=datetime.datetime.now)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cost_recording', to=settings.AUTH_USER_MODEL)),
            ],
            options={
