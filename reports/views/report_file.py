...
from reports.policies import ReportFileAccessPolicy


class ReportFileViewSet(mixins.CreateModelMixin,
    ...
    permission_classes = (ReportFileAccessPolicy,)
    ...
    def get_queryset(self):
        ...
        return self.access_policy.scope_queryset(
            self.request, LinkedFile.objects.filter(content_type=ct, object_id=self.kwargs['report_id'])
        )
