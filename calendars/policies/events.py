...
class EventsAccessPolicy(VerifiedAccessPolicy):
    statements = [
        {
            "action": ["list"],
        ...
        {
            "action": ["create"],
            "principal": ['permission:add_own_events'],
            "effect": "allow"
        },
    ]
    extra_statements = [
        ...
        },
        {
            ...
            "permissions":
                [
                    (['permission:delete_events'], None),
                    (['permission:delete_own_events'], 'is_own_event')
                ],
            "effect": "allow"
        },
        {
